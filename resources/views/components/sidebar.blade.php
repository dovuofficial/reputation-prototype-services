                ...
                @can('project_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/projects*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.projects.index") }}">
                            <i class="fa-fw c-sidebar-nav-icon fas fa-archway">
                            </i>
                            {{ trans('cruds.project.title') }}
                        </a>
                    </li>
                @endcan
                @can('staked_tokens_to_project_access')
                    <li class="items-center">
                        <a class="{{ request()->is("admin/staked-tokens-to-projects*") ? "sidebar-nav-active" : "sidebar-nav" }}" href="{{ route("admin.staked-tokens-to-projects.index") }}">
                            <i class="fa-fw c-sidebar-nav-icon fas fa-coins">
                            </i>
                            {{ trans('cruds.stakedTokensToProject.title') }}
                        </a>
                    </li>
                @endcan
